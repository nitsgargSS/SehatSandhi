...
export const PURGE_TABLES: PurgeTable[] = [
  ...
  { name: 'prescription_items', purgeOrder: 141, pk: 'id' },
  { name: 'patient_documents', purgeOrder: 142, pk: 'id' },
  { name: 'prescriptions', purgeOrder: 143, pk: 'id' },
  { name: 'prescription_counters', purgeOrder: 144, pk: 'business_id' },
