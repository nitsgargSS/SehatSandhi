...
export const PURGE_TABLES: PurgeTable[] = [
  ...
  { name: 'business_wallet_transactions', purgeOrder: 33, pk: 'id' },
  { name: 'business_wallets', purgeOrder: 34, pk: 'id' },
  { name: 'invoices', purgeOrder: 35, pk: 'id' },
  { name: 'invoice_counters', purgeOrder: 36, pk: 'fy' },
  { name: 'business_wa_accounts', purgeOrder: 37, pk: 'id' },
  ...
  { name: 'discharge_summaries', purgeOrder: 88, pk: 'id' },
  { name: 'discharge_counters', purgeOrder: 89, pk: 'business_id' },
  { name: 'medication_administrations', purgeOrder: 89.5, pk: 'id' },
  { name: 'admission_medication_orders', purgeOrder: 89.6, pk: 'id' },
  { name: 'camps_offers', purgeOrder: 90, pk: 'id' },
  { name: 'visit_findings', purgeOrder: 91, pk: 'id' },
  ...
  { name: 'patient_bill_items', purgeOrder: 97, pk: 'id' },
  { name: 'wards', purgeOrder: 98, pk: 'id' },
  { name: 'patient_bills', purgeOrder: 99, pk: 'id' },
  ...
  { name: 'practice_locations', purgeOrder: 110, pk: 'id' },
  { name: 'login_codes', purgeOrder: 112, pk: 'id' },
  { name: 'pricing_plan_events', purgeOrder: 114, pk: 'id' },
  ...
  { name: 'bot_search_log', purgeOrder: 151, pk: 'id' },
  ...
  { name: 'doctor_lead_notes', purgeOrder: 158, pk: 'id' },
  { name: 'doctor_leads', purgeOrder: 159, pk: 'id' },
  ...
  { name: 'site_events', purgeOrder: 254, pk: 'id' },
  { name: 'site_visits', purgeOrder: 255, pk: 'id' },
  { name: 'visitor_locations', purgeOrder: 256, pk: 'id' },
