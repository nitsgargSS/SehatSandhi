...
export const translations: Tree = {
  ...
  landing: {
    ...
    forDocCardDesc: {
      ...
      hi: 'Pricing aapke area ki population aur reach ke hisaab se hoti hai — isliye yeh kabhi flat, one-size-fits-all fee nahi hoti. Registration ke dauran apne areas select karein aur submit karne se pehle hi apna exact monthly price turant dekhein.',
    },
    forDocStep1: { en: 'Select your areas — see live pricing instantly', hi: 'Apne areas select karein — live pricing turant dekhein' },
    forDocStep2: { en: 'Submit your registration details', hi: 'Apni registration details submit karein' },
    forDocStep3: { en: "Our team verifies your MCI/NMC number (24-48 hours)", hi: 'Hamari team aapka MCI/NMC number verify karegi (24-48 ghante)' },
    forDocStep4: { en: 'Confirm payment matching your estimate — listing goes live', hi: 'Apne estimate ke hisaab se payment confirm karein — listing activate ho jayegi' },
