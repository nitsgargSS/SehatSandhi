...
export default function BusinessLanding() {
  return (
    <div style={{ background: BIZ.cream, fontFamily: font }}>
      {/* nav */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 40px', borderBottom: `1px solid ${BIZ.border}` }} className="max-w-7xl mx-auto flex-wrap gap-4">
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <img src="/logo-only-symbol.png" alt="" aria-hidden style={{ height: 50, width: 'auto', objectFit: 'contain' }} />
          <img src="/logo-title.png" alt="Sehatsandhi" style={{ height: 50, width: 'auto', objectFit: 'contain' }} />
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 28 }} className="flex-wrap">
      ...
      {/* hero */}
      <div className="max-w-7xl mx-auto grid gap-10 items-center px-10 py-14 lg:grid-cols-[1.15fr_.85fr]">
        <div>
          ...
          <h1 style={{ fontSize: 46, lineHeight: 1.08, fontWeight: 800, color: BIZ.ink, margin: '0 0 18px', letterSpacing: '-.03em' }}>Reach every patient in your pincodes.</h1>
          <p style={{ fontSize: 18, color: BIZ.muted, lineHeight: 1.55, margin: '0 0 28px', maxWidth: 520 }}>Doctors, hospitals, pharmacies, labs, insurers and ambulance services get discovered by families nearby — over WhatsApp &amp; SMS. Choose your pincodes, pay only for the audience you reach.</p>
          <div style={{ display: 'flex', gap: 14, alignItems: 'center', flexWrap: 'wrap' }}>
            <Link to="/business/register" style={{ background: BIZ.green, color: '#fff', fontWeight: 800, fontSize: 16, padding: '15px 26px', borderRadius: 14 }}>List your business — free to start</Link>
      ...
      {/* trust strip */}
      <div style={{ display: 'flex', justifyContent: 'center', gap: 48, padding: '20px 40px', background: BIZ.creamAlt, borderTop: `1px solid ${BIZ.border}`, borderBottom: `1px solid ${BIZ.border}`, flexWrap: 'wrap' }}>
      ...
      {/* how it works */}
      <div id="how" className="max-w-7xl mx-auto px-10 py-14">
        <h2 style={{ fontSize: 28, fontWeight: 800, color: BIZ.ink, textAlign: 'center', margin: '0 0 8px', letterSpacing: '-.02em' }}>How zipcode reach works</h2>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {[
            ...
            <div key={s.n} style={{ background: '#fff', border: `1px solid ${BIZ.border}`, borderRadius: 18, padding: 26 }}>
      ...
      <div className="max-w-7xl mx-auto px-10 pb-10">
        <h3 style={{ fontSize: 22, fontWeight: 800, color: BIZ.ink, margin: '0 0 20px' }}>Who can list</h3>
      ...
      <div id="pricing" className="max-w-7xl mx-auto px-10 pb-14">
        <h2 style={{ fontSize: 28, fontWeight: 800, color: BIZ.ink, textAlign: 'center', margin: '0 0 8px', letterSpacing: '-.02em' }}>Pay for reach, not clicks</h2>
          ...
          {PRICING_TIERS.map(tier => {
            ...
            return (
              <div key={tier.tier_number} style={{
                ...
                <div style={{ fontSize: 34, fontWeight: 800, color: hot ? '#fff' : BIZ.ink, letterSpacing: '-.02em' }}>₹{tier.monthly_price.toLocaleString('en-IN')}<span style={{ fontSize: 15, fontWeight: 600, color: hot ? '#d6f2e6' : BIZ.mutedWarm }}>/mo</span></div>
      ...
      <div className="max-w-7xl mx-auto px-10 pb-6">
        <div style={{ display: 'grid', gap: 40, alignItems: 'center' }} className="lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <h2 style={{ fontSize: 30, fontWeight: 800, color: BIZ.ink, margin: '10px 0 12px', letterSpacing: '-.02em' }}>Booking happens inside WhatsApp</h2>
          ...
          <div className="flex justify-center"><WhatsAppBotMock /></div>
        </div>
      </div>

      {/* cta band */}
      <div className="max-w-7xl mx-auto px-10 pb-16">
        <div style={{ background: 'linear-gradient(120deg,#14201c,#1f3a30)', borderRadius: 22, padding: 44, textAlign: 'center' }}>
          <h3 style={{ fontSize: 28, fontWeight: 800, color: '#fff', margin: '0 0 10px', letterSpacing: '-.02em' }}>Ready to reach patients near you?</h3>
          <p style={{ fontSize: 16, color: '#b9c9c1', margin: '0 0 24px' }}>Set up your listing in under 5 minutes. No upfront cost to register.</p>
          <Link to="/business/register" style={{ display: 'inline-block', background: BIZ.green, color: '#fff', fontWeight: 800, fontSize: 16, padding: '15px 30px', borderRadius: 14 }}>Start onboarding</Link>
        </div>
      </div>
    </div>
  )
