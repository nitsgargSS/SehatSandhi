    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 pt-16">
      <div className="card max-w-md w-full shadow-xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-navy-700">Doctor Login</h1>
          <p className="text-gray-400 text-sm mt-1">Access your Sehatsandhi dashboard</p>
        </div>
        ...
        <div className="mt-6 text-center space-y-2">
          <p className="text-sm text-gray-500">New doctor? <Link to="/doctor" className="text-teal-600 hover:underline font-medium">Register here</Link></p>
          <button className="text-xs text-gray-400 hover:text-gray-600">Forgot password?</button>
        </div>
      </div>
    </div>
  )
