...
const content = {
  en: {
    ...
    sections: [
      ...
      {
        h: '3. We Do Not Store Health Records',
      ...
      {
        h: '4. WhatsApp Messaging Data',
        p: "Since booking happens over WhatsApp, please note that WhatsApp's own data handling also applies — Meta's Cloud API retains message content for a maximum of 30 days, and deletes user identifiers within 30 days of the last message status update. This is separate from and in addition to the limited booking information described in Section 3, which we store only for as long as needed to facilitate your appointment.",
      },
      {
        h: '5. Data Sharing',
    ...
    sections: [
      {
        ...
        p: 'मरीज़ों से: नाम, फ़ोन नंबर, उम्र, और अपॉइंटमेंट बुक करते समय आपके द्वारा शेयर की गई डिटेल्स (चाहिए स्पेशलिटी, एरिया/PIN कोड)। डॉक्टरों और पार्टनर्स से: रजिस्ट्रेशन डिटेल्स, क्वालिफिकेशन, क्लिनिक एड्रेस, फ़ोन, ईमेल, और लिस्टिंग फीस के लिए पेमेंट जानकारी। हम Google Analytics का भी इस्तेमाल करते हैं वेबसाइट ट्रैफिक समझने के लिए (एनोनिमाइज्ड, एग्रीगेट डेटा — किसी इंडिविजुअल मरीज़ से जुड़ा नहीं)। इसके अलावा, हम अपने सिस्टम पर एनोनिमस यूसेज इवेंट्स रिकॉर्ड करते हैं: कौनसे पेज खोले गए, कौनसी स्पेशलिटी या एरिया सर्च किया गया, कौनसी लिस्टिंग्स दिखाई गईं, देखी गईं या टैप की गईं, और WhatsApp या कॉल बटन कब इस्तेमाल हुआ। हर इवेंट के साथ एक टेम्पररी पर-विज़िट आइडेंटिफायर होता है जो टैब बंद करते ही खत्म हो जाता है, आपका डिवाइस टाइप (मोबाइल, टैबलेट या डेस्कटॉप), और वो वेबसाइट जहां से आप आए। हम आपका IP एड्रेस, GPS लोकेशन या कोई डिवाइस फिंगरप्रिंट रिकॉर्ड नहीं करते, और पेज एड्रेस से सर्च टेक्स्ट हटा देते हैं स्टोर करने से पहले — ये इवेंट्स आपके नाम या फ़ोन नंबर से जुड़े नहीं होते। हम इन्हें सर्विस बेहतर बनाने और पार्टनर्स को उनकी अपनी लिस्टिंग की परफॉर्मेंस दिखाने के लिए इस्तेमाल करते हैं। अगर आपका ब्राउज़र "Do Not Track" सिग्नल भेजता है, तो हम कोई भी यूसेज इवेंट रिकॉर्ड नहीं करते।',
      },
      {
        h: '2. हम आपकी जानकारी का इस्तेमाल कैसे करते हैं',
      ...
      {
        h: '3. हम हेल्थ रिकॉर्ड्स स्टोर नहीं करते',
      ...
      {
        h: '4. WhatsApp मैसेजिंग डेटा',
        p: 'चूंकि बुकिंग WhatsApp पर होती है, कृपया ध्यान दें कि WhatsApp की अपनी डेटा हैंडलिंग भी लागू होती है — Meta का Cloud API मैसेज कंटेंट को ज़्यादा से ज़्यादा 30 दिन तक रखता है, और लास्ट मैसेज स्टेटस अपडेट के 30 दिन के अंदर यूज़र आइडेंटिफायर्स डिलीट कर देता है। यह सेक्शन 3 में बताई गई लिमिटेड बुकिंग जानकारी से अलग और अतिरिक्त है, जिसे हम सिर्फ आपकी अपॉइंटमेंट फैसिलिटेट करने के लिए ज़रूरी समय तक स्टोर करते हैं।',
      },
      {
        h: '5. डेटा शेयरिंग',
