...
const PARTNER_TYPES: PartnerCard[] = [
  { icon: '🏥', titleEn: 'Doctors & Clinics', titleHi: 'डॉक्टर एवं क्लिनिक', descEn: 'Grow your clinic\'s reach — patients will find you on WhatsApp', descHi: 'Apni clinic ki reach badhayein — patients WhatsApp par dhundhenge', to: '/doctor', ctaEn: 'Register as Doctor', ctaHi: 'Doctor Register Karein' },
  { icon: '💊', titleEn: 'Pharmacies', titleHi: 'दवाई की दुकान', descEn: 'Prescriptions come straight to you — deliver to homes', descHi: 'Prescriptions seedhi aapke paas — ghar delivery karein', to: '/partner', ctaEn: 'Become a Pharmacy Partner', ctaHi: 'Pharmacy Partner Banein' },
  { icon: '🔬', titleEn: 'Diagnostic Labs', titleHi: 'जांच केंद्र', descEn: 'Test bookings come straight to you — offer home collection', descHi: 'Test bookings seedhe aapke paas — home collection karein', to: '/partner', ctaEn: 'Become a Lab Partner', ctaHi: 'Lab Partner Banein' },
